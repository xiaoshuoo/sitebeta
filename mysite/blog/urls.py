...
urlpatterns = [
    ...
    path('templates/gutierrez/', views.gutierrez_templates, name='gutierrez_templates'),
    path('templates/gutierrez/<int:template_id>/edit/', views.edit_gutierrez_template, name='edit_gutierrez_template'),
    path('templates/gutierrez/<int:template_id>/delete/', views.delete_gutierrez_template, name='delete_gutierrez_template'),
    path('templates/rossi/', views.rossi_templates, name='rossi_templates'),
    path('templates/rossi/<int:template_id>/edit/', views.edit_rossi_template, name='edit_rossi_template'),
    path('templates/rossi/<int:template_id>/delete/', views.delete_rossi_template, name='delete_rossi_template'),
