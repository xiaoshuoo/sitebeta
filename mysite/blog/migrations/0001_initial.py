    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail', models.ImageField(blank=True, null=True, upload_to='post_thumbnails/', verbose_name='Обложка поста')),
                ...
                ('attachments', models.ManyToManyField(blank=True, related_name='posts', to='blog.postattachment')),
            ],
            options={
                'verbose_name': 'Пост',
